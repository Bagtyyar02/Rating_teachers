...
{
    [NonPersistent]
    class action_query_model:XPCustomObject
    {
        #region Properties
        int faction_id;
        [Key(true)]
        ...
        string fmukdar;
        [Size(50)]
        public string mukdar
        {
            get { return fmukdar; }
            set { SetPropertyValue<string>(nameof(mukdar), ref fmukdar, value); }
        }
        ...
        #region procedures
        public action_query_model(Session session) : base(session) { }
